...
if do_simulation == True:
    # Example usage
    simulator = simPCR(length=30, number_of_rows=100)
    ...
    simulator.amplify_old(amplification_probability=0.9, error_rate=0.004, error_types=error_types, amplification_cycles=8)
